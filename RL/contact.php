...
<head>
    ...
    <link rel="icon" href="mainLogo/FAVICON.png" type="image/png">
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark navBar">
        ...
        <a class="navbar-brand" href="index.html"><img src="mainLogo/RL MAIN LOGO.png"
                class="img-Fluid float-left mainLogo" alt="RAPID LYRICS LOGO"></a>
    ...
    <div class="container-fluid containerBody">
        ...
        <div class="container containerBody">
            <h4 class="pt-3 txt-cent txt-family"> Fill Out This Form Will Send Your Message Directly To Rapid Lyrics.
            </h4>
            <hr class="hr">
            <form class="txt-cent font-weight-bolder" action="contact.php" method="post">
                <div class="form-group">
                    <label for="formGroupExampleInput">YOUR NAME</label>
                    <input type="text" name="name" id="name" class="form-control txt-cent" id="formGroupExampleInput"
                        placeholder="Write Your Name Here..">
                </div>

                <div class="form-group">
                    <label for="exampleInputEmail1">EMAIL ADDRESS</label>
                    <input type="text" name="email" id="email" class="form-control txt-cent" id="exampleInputEmail1"
                        aria-describedby="emailHelp" placeholder="Write Your Email-Address">
                </div>
                <div class="form-group">
                    <label for="formGroupExampleInput">SUBJECT</label>
                    <input type="text" name="subject" id="subject" class="form-control txt-cent "
                        id="formGroupExampleInput" placeholder="Write Which Topic You Want To Discuss..">
                </div>
                <div class="form-group">
                    <label for="exampleFormControlTextarea1">MESSAGE</label>
                    <textarea class="form-control txt-cent" id="exampleFormControlTextarea1" name="message"
                        rows="5"></textarea>
                </div>
